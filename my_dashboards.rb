...
dasht do |d|
  ...
  # Publish a board.
  d.board do |b|
    b.value :lines, :title => "Number of Lines", :resolution => 999, :width => 2, :height => 1, :fontsize => :large
    b.value :bytes, :title => "Number of Bytes", :resolution => 999, :width => 2, :height => 1, :fontsize => :large
    b.value :bytes, :title => "Number of Bytes", :resolution => 999, :width => 2, :height => 1, :fontsize => :large
