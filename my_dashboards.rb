...
dasht do |d|
  ...
  # Publish a board.
  d.board do |b|
    b.metric :lines, :title => "Number of Lines", :resolution => 999, :refresh => 5, :width => 4, :height => 3, :fontsize => :large
    b.metric :bytes, :title => "Number of Bytes", :resolution => 999, :refresh => 5, :width => 4, :height => 3, :fontsize => :large
    # b.chart :bytes, :title => "Chart of Bytes", :resolution => 60, :refresh => 5, :width => 4, :height => 3
